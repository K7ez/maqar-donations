<section>
    <header>
        ...
        <p class="mt-1 text-sm text-inkmuted">
            قم بتحديث بيانات ملفك الشخصي وعنوان بريدك الإلكتروني.
        </p>
    </header>
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="text-sm mt-2 text-ink">
                        ...
                        <button form="send-verification" class="underline text-sm text-inkmuted hover:text-primary rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
